...
class when_user_submits_quiz: XCTestCase {
    ...
    func test_should_navigate_to_the_grade_screen_and_display_their_grade() {
        ...
        questionListTable.cells["1, What is 2+2?, Square, 3, Square, 4, Square, 22, Square, 6"].descendants(matching: .image).element(boundBy: 1).tap()
        
        questionListTable.cells["2, What is 5+2?, Square, 3, Square, 4, Square, 7, Square, 6"].descendants(matching: .image).element(boundBy: 2).tap()
        questionListTable.cells["3, What is 10+5?, Square, 3, Square, 4, Square, 7, Square, 15"].descendants(matching: .image).element(boundBy: 3).tap()
